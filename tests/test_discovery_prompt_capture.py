...
class TestDiscoveryPromptCapture:
    ...
    def test_idle_question_elicits_the_typed_carrierless_slot(self):
    ...
    def test_typed_discovery_directive_uses_existing_topic_slot(self):
        assert AlexaResponse.typed_discovery_directive() == {
